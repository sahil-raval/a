...
const articles = [
  ...
  },
  {
    ...
    excerpt: "How precise evaluation and masterful regrinding can elevate an Internally Flawless stone to fully Flawless, unlocking significant premiums.",
    category: "Investment"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    excerpt: "From traditional craftsmanship to modern precision: How technology and expertise are reshaping how we evaluate and cut premium stones globally.",
    category: "Innovation"
  }
];
          ...
          <div className="space-y-12 border-t border-border pt-12">
            {articles.map((article, i) => (
              <motion.article 
                ...
                className="grid md:grid-cols-[1fr_3fr] gap-4 md:gap-12 group pb-12 border-b border-border"
              >
                ...
                <div>
                  <Link href={`/journal/${article.id}`} data-testid={`link-article-${article.id}`}>
